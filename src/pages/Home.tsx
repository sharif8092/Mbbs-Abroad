      ...
      <section className="py-24 bg-gradient-to-br from-blue-900 to-slate-900 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a href="tel:+917909096738" className="bg-white text-blue-900 px-10 py-4 rounded-2xl font-black text-sm tracking-widest shadow-2xl shadow-blue-500/10 hover:-translate-y-1 transition-all active:scale-95">
